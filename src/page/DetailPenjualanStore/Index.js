...
function DetailPenjualanStore(props) {
  ...
  //     setDataDetail(data)
  // },[data])
  console.log(dataDetail.detailPenjualan);
  ...
  const loginForm = (
    <Formik
      initialValues={{
        kodeTransaksi: dataDetail.IDTransaksi,
        kodeStore: dataDetail.IDStore,
        lokasiStore: dataDetail.LokasiStore,
        diskon: dataDetail.diskon,
        metodePembayaran: dataDetail.metodePembayaran,
        ekspedisi: dataDetail.ekspedisi,
        ongkir: dataDetail.ongkir,
        total: dataDetail.Total,
        kembalian: dataDetail.kembalian,
      }}
